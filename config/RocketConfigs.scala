...
class RocketConfig extends Config(
  ...
  new freechips.rocketchip.subsystem.WithzzguardRoCC ++
  new freechips.rocketchip.subsystem.WithNBigCores(2) ++         // single rocket-core
  new chipyard.config.AbstractConfig)

//===== zzguardrr: Start ====//
// class TwoRocketConfig extends Config(
//   new freechips.rocketchip.subsystem.WithNBigCores(2) ++         // two rocket-core
//   new freechips.rocketchip.subsystem.WithzzguardrrRoCC ++
//   new chipyard.config.AbstractConfig)
//===== zzguardrr: End   ====//
